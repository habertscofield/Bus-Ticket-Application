...
public final class ListTicketsBinding implements ViewBinding {
  @NonNull
  ...
  private ListTicketsBinding(@NonNull CardView rootView, @NonNull TextView busname,
  ...
  @NonNull
  public static ListTicketsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListTicketsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_tickets, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListTicketsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListTicketsBinding((CardView) rootView, busname, fromLocation, issueDate,
