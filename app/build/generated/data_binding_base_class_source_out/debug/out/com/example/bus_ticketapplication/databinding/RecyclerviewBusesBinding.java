...
public final class RecyclerviewBusesBinding implements ViewBinding {
  @NonNull
  ...
  private RecyclerviewBusesBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView busImage,
  ...
  @NonNull
  public static RecyclerviewBusesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RecyclerviewBusesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.recyclerview_buses, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RecyclerviewBusesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerviewBusesBinding((ConstraintLayout) rootView, busImage, textViewBusName,
